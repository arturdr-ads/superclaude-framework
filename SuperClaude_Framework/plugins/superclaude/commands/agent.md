...
4. Check Serena integration: `🔍 Serena: available|fallback`.
...
- **Serena integration**: Use semantic code understanding when available, fallback gracefully to local files.
